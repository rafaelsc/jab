...
{
    internal partial class Improved2ContainerSingleton : global::System.IDisposable, System.IAsyncDisposable,
       ...
       IServiceProvider<Microsoft.Extensions.DependencyInjection.IServiceProviderIsService>
    {
        ...
        Jab.Performance.Basic.Singleton.ISingleton2 IServiceProvider<Jab.Performance.Basic.Singleton.ISingleton2>.GetService() => LazyInitializer.EnsureInitialized<Jab.Performance.Basic.Singleton.Singleton2>(ref this._ISingleton2);
        Jab.Performance.Basic.Singleton.ISingleton3 IServiceProvider<Jab.Performance.Basic.Singleton.ISingleton3>.GetService() => LazyInitializer.EnsureInitialized<Jab.Performance.Basic.Singleton.Singleton3>(ref this._ISingleton3);
           ...
           IServiceProvider<Microsoft.Extensions.DependencyInjection.IServiceProviderIsService>
        {
            ...
            private Jab.Performance.Basic.Singleton.Improved2ContainerSingleton _root;

            public Scope(Jab.Performance.Basic.Singleton.Improved2ContainerSingleton root)
            {
                _root = root;
            }
